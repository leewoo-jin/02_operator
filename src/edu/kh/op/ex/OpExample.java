...
public class OpExample {
      ...
      //ex1() method ; 객체 지향 프로그램에서 객체와 관련된 함수
	  //-> OpExample이 가지고 있는 기능 중 ex1()이라는 기능
		public void ex1() {
			//syso + ctrl space 자동완성
			System.out.println("OpExample 클래스ex1()기능 수행");
				System.out.println("클래스 분리 테스트");
				System.out.println("println 자돟완성도 배웠어요~");
       ...
       public void ex2() {
    	   ...
    	   //실행될 때 Example -> OpExample -> Scanner 순으로 만들어냄
    	  // Scanner는 같은 패키지내에 있지 않기 떄문에 import(수입) 해와야한다.
       ...
       public void ex5( ) {
    	   ...
    	   System.out.println( b <= 10); //b 는 10 이하인가? true
    	   ...
    	   //||(OR) 연산자 : 둘 다 false 면 false, 나머지는 true(AND의 반대)
    	   //또는,~거나,~이거나
       ...
       public void ex6( ) {
    	   ...
    	   System.out.printf("%d은/는 1 미만, 100초과 정수인가? : %b/&b\n",input,result2,result3);
       ...
       public void ex7() {
    	   ...
    	   System.out.printf("a를 1 증가 : " + a);
    	   
    	   //a를 4 증가
    	   a += 4; // a = a = 4;
    	   System.out.printf("a를 4증가 :" + a);
    	   
    	   //a 를 10감소 
    	   a-= 10; // a = a -10 ;
    	   System.out.printf("a를 10감소 :" + a ); //5
    	   
    	   //a를 3배증가
    	   a*=3;
    	   System.out.printf("a를 3배 증가 :" +a); //15
    	   
    	   //a를 6으로 나눴을때 몫
    	   a /=6;
    	   System.out.printf("a를 6으로 나눴을 때 몫 :"+ a); //2
    	   
    	   //a를 2로 나눴을때 나머지
    	   a%=2;
    	   System.out.printf("a를 2로 나눴을때 나머지:" + a); //0
